...
class RingtoneController extends Controller
{
  ...
  function send_notificationToken ($tokens, $message,$key)
    ...
    public function addAction(Request $request)
    {
        ...
        $form = $this->createForm(new RingtoneType(),$ringtone);
    ...
    public function indexAction(Request $request)
    {
        ...
        $ringtones_list=$em->getRepository('AppBundle:Ringtone')->findAll();
	      ...
	      return $this->render('AppBundle:Ringtone:index.html.twig',array("ringtones"=>$ringtones,"ringtones_count"=>$ringtones_count));    
	  }
